...
export const envSchema = z.object({
    ...
    VIDEOS_COMMENT_MONGO_DB_SHARD_1_PORT: z.coerce.number().min(1),

    VIDEOS_COMMENT_MONGO_DB_SHARD_2_HOST: nonEmptyStr('VIDEOS_COMMENT_MONGO_DB_SHARD_2_HOST'),
    VIDEOS_COMMENT_MONGO_DB_SHARD_2_PORT: z.coerce.number().min(1),
