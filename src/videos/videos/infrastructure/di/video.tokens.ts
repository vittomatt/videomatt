export const VIDEO_TOKEN = {
    ...
    VIDEO_WITH_AMOUNT_OF_COMMENTS_DB_MODEL: Symbol('VIDEO_VIDEO_WITH_AMOUNT_OF_COMMENTS_DB_MODEL'),
    ...
    // Domain Handlers
    CREATE_VIDEO_WITH_AMOUNT_OF_COMMENTS_HANDLER: Symbol('CREATE_VIDEO_WITH_AMOUNT_OF_COMMENTS_HANDLER'),
    ...
    CREATE_VIDEO_WITH_AMOUNT_OF_COMMENTS_USE_CASE: Symbol('CREATE_VIDEO_WITH_AMOUNT_OF_COMMENTS_USE_CASE'),
    ...
    VIDEO_WITH_AMOUNT_OF_COMMENTS_REPOSITORY: Symbol('VIDEO_WITH_AMOUNT_OF_COMMENTS_REPOSITORY'),
