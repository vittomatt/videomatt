...
import { SQSEventVideoCreatedConsumer } from '@videos/videos/infrastructure/broker/consumers/sqs-event-video-created.consumer';
...
import { GetVideosHandler } from '@videos/videos/infrastructure/handlers/query/get-videos.handler';
