...
export class SQSEventVideoPublishedConsumer extends SQSEventConsumer {
    constructor(
        ...
        @inject(TOKEN_VIDEO.SQS_VIDEO_PUBLISHED_QUEUE_URL) protected readonly queueUrl: string,
        @inject(TOKEN.LOGGER) protected readonly logger: Logger,
        @inject(TOKEN_USER.INCREASE_AMOUNT_OF_VIDEOS_ON_VIDEO_PUBLISHED_HANDLER)
